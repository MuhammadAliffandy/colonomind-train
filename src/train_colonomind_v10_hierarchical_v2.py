"""
ColonoMind v10 — Hierarchical Mod-SE V2 Pipeline
=================================================
...
Optimisations for >80% Accuracy AND Balanced F1:
  1. Mod-SE V2 Architecture (CBAM + Residuals).
  2. Hierarchical Strategy:
     - Stage 1: Detector (Normal vs Active Disease).
     - Stage 2: Grader (MES1 vs MES2 vs MES3).
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='../Result/ColonoMind_v10_HierarchicalModSEV2')
    parser.add_argument('--epochs', type=int, default=100)
    args = parser.parse_args()
    
    os.makedirs(args.save_dir, exist_ok=True)
    print("="*70); print("🚀 COLONOMIND v10 — Hierarchical Mod-SE V2"); print("="*70)
    ...
    print("\n" + "="*70); print("STAGE 1/4: Training Mod-SE V2 Detector (Normal vs Active)"); print("="*70)
    stage1_models = []
    ...
    print("\n" + "="*70); print("STAGE 2/4: Training Mod-SE V2 Grader (MES1 vs 2 vs 3)"); print("="*70)
    stage2_models = []
    ...
    print("\n🏆 V10 Hierarchical Mod-SE V2 Final Metrics:")
